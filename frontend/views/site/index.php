				  ...
				  <div id="rev_slider_116_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
					  <ul style="width:100% !important;" class="homesix_slide">
						  ...
						  <li data-index="rs-391" data-transition="parallaxhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-rotate="0" data-saveperformance="off" data-title="Smooth Mask" data-description="">
							  ...
							  <img src="images/Home/Home6/Home7-slide.jpg" alt="slide1" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
							 ...
							 data-x="730" data-hoffset="" 
									...
									<h2 class="tour_text_yellow" style="font-size:160px; line-height:60px;">LUXE</h2>
							 ...
							 data-x="670" data-hoffset="" 
									...
									<span style="font-size:30px; line-height:60px;">#</span><br/>
							 ...
							 data-x="670" data-hoffset="" 
									...
									data-splitout="none" 
									data-responsive_offset="on" >
									<div class="ever_tag_text" style="font-size:50px; line-height:60px; font-weight:300;">WORLD VACATIONS</div>
							 ...
							 data-x="670" data-hoffset="" 
									...
									data-splitout="none" 
									data-responsive_offset="on" >
									<h3 class="tour_text" style="font-size:30px; line-height:60px;">YOU'LL LOVE WHERE WE TAKE YOU</h3>
						  ...
						  <li data-index="rs-392" data-transition="parallaxhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-rotate="0" data-saveperformance="off" data-title="Smooth Mask" data-description="">
							 ...
							 <!-- MAIN IMAGE -->
							  <img src="images/Home/Home6/Home6-slide.jpg" alt="slide1" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
							 <!-- MAIN IMAGE -->
							 ...
							 data-x="730" data-hoffset="" 
									...
									<h2 class="tour_text_yellow" style="font-size:160px; line-height:60px; text-align: center;">LUXE</h2>
				...
				<div class="heading_team">
					...
					<p>Create stunning pages with our powerful admin panel. Functionality and usability combine. Travelllers Deals and Offers on Hotels, Vacation Packages, Flights, Cruises and Car Rentals</p>
					       ...
					       <div class="col-lg-6 col-md-6 col-sm-6">
							...
							<img src="images/Home/home-destination1.jpg" class="img-responsive" alt="destination">
							
							<div class="full_width offer_inner_desc">
							<div class="desc_left_inner"><a href="#">EIFFEL TOWER /<span>Paris</span></a></div>
							<div class="desc_right_inner">$2,000 <span>7days</span></div>
							</div>
					 </div>
					</div>
					<!-- first ractangle End -->
					...
					<!-- second ractangle start -->
					       <div class="col-lg-6 col-md-6 col-sm-6">
							...
							<img src="images/Home/home-destination2.jpg" class="img-responsive" alt="destination">
							
							<div class="full_width offer_inner_desc">
							<div class="desc_left_inner"><a href="#">CHICAGO /<span>USA</span></a></div>
							<div class="desc_right_inner">$3,000 <span>8days</span></div>
							</div>
					 </div>
					</div>
					...
					<!-- thired ractangle start -->
					       <div class="col-lg-6 col-md-6 col-sm-6">
							...
							<img src="images/Home/home-destination3.jpg" class="img-responsive" alt="destination">
							
							<div class="full_width offer_inner_desc">
							<div class="desc_left_inner"><a href="#">lighthouse /<span>Yaquina</span></a></div>
							<div class="desc_right_inner">$1,000 <span>4days</span></div>
							</div>
					 </div>
					</div>
					...
					<!-- fourth ractangle start -->
					       <div class="col-lg-6 col-md-6 col-sm-6">
							...
							<img src="images/Home/home-destination4.jpg" class="img-responsive" alt="destination">
							
							<div class="full_width offer_inner_desc">
							<div class="desc_left_inner"><a href="#">Milos Island /<span>Greece</span></a></div>
							<div class="desc_right_inner">$3,500 <span>9days</span></div>
							</div>
					 </div>
					</div>
...
<!-- top destination section End -->
			  ...
			  <div class="row">
				  ...
				  <div class="col-lg-3 col-md-3 col-sm-6">
					  <div class="hotel_feature_box">
					   <img src="images/Home/feature1.jpg" class="img-responsive" alt="feature">
						  <div class="feature_overlay_second">
							   <div class="bottom_first"><a href="Hotel-Details.html">park central</a><span>$150</span></div>
							   <div class="bottom_second">australia<span>/Night</span></div>
							</div>
					  </div>
				  </div>
				  <div class="col-lg-3 col-md-3 col-sm-6">
					  <div class="hotel_feature_box">
					   <img src="images/Home/feature2.jpg" class="img-responsive" alt="feature">
						  <div class="feature_overlay_second">
							   <div class="bottom_first"><a href="Hotel-Details.html">Satvik Resort</a><span>$150</span></div>
							   <div class="bottom_second">Singapore <span>/Night</span></div>
							</div>
					  </div>
				  </div>
				  <div class="col-lg-3 col-md-3 col-sm-6">
					  <div class="hotel_feature_box">
					   <img src="images/Home/feature3.jpg" class="img-responsive" alt="feature">
						  <div class="feature_overlay_second">
							   <div class="bottom_first"><a href="Hotel-Details.html">Marlus Hotel</a><span>$150</span></div>
							   <div class="bottom_second">Malaysia <span>/Night</span></div>
							</div>
					  </div>
				  </div>
				  ...
				  <div class="col-lg-3 col-md-3 col-sm-6">
					  <div class="end_box_fearure">
						  <h3 class="travelite_heading_feature">EXPERIENCES</h3>
 ...
 <!--  special offer section start -->
			...
			<div class="row">
				...
				<div class="heading_team">
					...
					<p>Create stunning pages with our powerful admin panel. Functionality and usability combine. Travelllers Deals and Offers on Hotels, Vacation Packages, Flights, Cruises and Car Rentals</p>
				            ...
				            <div class="full_width upper_space_50">
						   <!-- first ractangle start -->
					       <div class="col-lg-3 col-md-3 col-sm-6">
							...
							<img src="images/Home/offer-1.jpg" class="img-responsive" alt="offer">
					...
					<!-- second ractangle start -->
					       <div class="col-lg-3 col-md-3 col-sm-6">
							...
							<div class="img_overlay_wrapper">
							<img src="images/Home/offer-2.jpg" class="img-responsive" alt="offer">
							<div class="img_overlay">
							</div>
							</div>
							<div class="full_width offer_inner">
					...
					<!-- thired ractangle start -->
					       <div class="col-lg-3 col-md-3 col-sm-6">
							...
							<div class="img_overlay_wrapper">
							<img src="images/Home/offer-3.jpg" class="img-responsive" alt="offer">
							<div class="img_overlay">
							</div>
							</div>
							<div class="full_width offer_inner">
					...
					<!-- fourth ractangle start -->
					       <div class="col-lg-3 col-md-3 col-sm-6">
							...
							<div class="img_overlay_wrapper">
							<img src="images/Home/offer-4.jpg" class="img-responsive" alt="offer">
							<div class="img_overlay">
							</div>
							</div>
							<div class="full_width offer_inner">
		  ...
		  <div class="container">
			  ...
			  <div class="offer_feature_wrapper">
				 <div class="col-lg-3 col-md-3 col-sm-6">
					...
					<h3 class="travelite_heading_feature">Cruises</h3>
					<p>Create stunning pages with our powerful admin </p>
					<div> <a href="#" class="black_btn">view more</a></div>
				</div>
				  </div>
	 ...
	 <div class="full_width feature_video_section">
	 <!-- left_feature_section_start -->
			<div class="left_side_feature_section">
			<div class="overlay_feature_vdo">
			</div>
		      <div class="container_1">
			 <h3>our features</h3>
			 <div class="feauteure_circles full_width">
			 <div class="col_50">
			 <div class="icon_wrap_feature">
			...
			</div><!-- left_feature_section_end -->
		
		<!-- right_video_section start -->
	<div class="right_side_video_section">
		<video id="player2" controls="controls" poster="images/video_banner.jpg">
	<source src="" type="video/mp4" title="mp4">
</video>
			</div>
			<!-- right_video_section End -->
	 </div>
	...
	<div class="full_width our_partners_crousel_section">
		...
		<div class="heading_team">
			...
			<div id="partner_crousel_slide">
              <div class="item"><img src="images/Home/Home5/partner-logo1.png" alt="logo image"></div>
              <div class="item"><img src="images/Home/Home5/partner-logo2.png" alt="logo image"></div>
              <div class="item"><img src="images/Home/Home5/partner-logo3.png" alt="logo image"></div>
              <div class="item"><img src="images/Home/Home5/partner-logo4.png" alt="logo image"></div>
              <div class="item"><img src="images/Home/Home5/partner-logo5.png" alt="logo image"></div>
              <div class="item"><img src="images/Home/Home5/partner-logo1.png" alt="logo image"></div>
              <div class="item"><img src="images/Home/Home5/partner-logo2.png" alt="logo image"></div>
			  <div class="item"><img src="images/Home/Home5/partner-logo3.png" alt="logo image"></div>
              <div class="item"><img src="images/Home/Home5/partner-logo4.png" alt="logo image"></div>
	   ...
	   <div class="container">
			  ...
			  <div id="home_testimonials" class="owl-carousel owl-theme">
						<!--  item one  start -->
							...
							<img src="images/Home/testimonial-thumb.png" class="img-circle" alt="testimonial-thumb">
							<h4>Ana Levley</h4>
							<p>HeapsTech, CEO</p>
							</div>
							</div>
						...
						<!--  item two  start -->
							...
							<div class="col-lg-4 col-md-4 col-sm-4 pad_z">
							<div class="testimonial_img_part">
							<img src="images/Home/Hnmn2.jpg" class="img-circle" alt="testimonial-thumb">
							<h4>Ana Levley</h4>
							<p>HeapsTech, CEO</p>
							</div>
							</div>
